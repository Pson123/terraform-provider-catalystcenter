...
func TestAccCcFabricMulticast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_fabric_multicast.test", "replication_mode", "HEADEND_REPLICATION"))

	var steps []resource.TestStep
	steps = append(steps, resource.TestStep{
		Config: testAccCcFabricMulticastPrerequisitesConfig + testAccCcFabricMulticastConfig_all(),
...
const testAccCcFabricMulticastPrerequisitesConfig = `
